...
<div class="order-history">
    <ul class="nav nav-tabs" id="myTab">
      <li class="active"><a data-toggle="tab" href="#imeiorders"><?php echo $this->lang->line('tab_imei_orders'); ?></a></li>
			<li class=""><a data-toggle="tab" href="#serverorders"><?php echo $this->lang->line('tab_server_orders'); ?></a></li>
      <li class=""><a data-toggle="tab" href="#latestnews"><?php echo $this->lang->line('tab_credit'); ?></a></li>
    </ul>
