          ...
          <div class="row">
            <?php echo form_open('member/dashboard/editprofile', array('role' => 'form', 'method' => 'post','id' => 'imeireq' ,'name' => 'form2', 'class' => 'form-horizontal')); ?>
              <?php echo form_hidden("ID", $data[0]['ID']); ?>      
                ...
                <div class="form-group">
                <label class="control-label"><?php echo $this->lang->line('my_account_lb_current_password') ?></label>
                <div class="col-8">
                ...
                <div class="form-group">
                <label class="control-label"><?php echo $this->lang->line('my_account_lb_new_password') ?></label>
                <div class="col-8">
              ...
              <div class="form-group">
                <label class="control-label"><?php echo $this->lang->line('my_account_lb_confirm_new_password') ?></label>
                <div class="col-8">
              ...
              <div class="form-group">
                <div class="col-12 text-center">
                  <button type="submit" class="btn btn-primary btn-sm"><?php echo $this->lang->line('my_account_btn_update') ?></button>
                </div>
              </div>
            <?php echo form_close(); ?>
          </div>
