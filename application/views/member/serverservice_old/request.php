    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <select name="ServerServiceID" id="ServerServiceID" class="form-control" required>
                        ...
                        <optgroup label="<?php echo $box['Title'] ?>">
                            ...
                            <option value="<?php echo $service['ID'] ?>"
                                ...
                                <?php echo $service['Title'].'- Only '.$service['Price'].' credit required'; ?></option>
                            <?php endforeach; ?>
                        </optgroup>
                        <?php endif; ?>
                        <?php endforeach; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="email" name="Email" placeholder="<?php echo $this->lang->line('imei_fields_email') ?>"
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
                <button type="submit"
                    class="btn btn-warning btn-lg"><?php echo $this->lang->line('imei_fields_submit') ?></button>
            </div>
        </div>
        <?php echo form_close(); ?>
